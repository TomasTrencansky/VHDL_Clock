...
REM
REM Generated by Vivado on Thu Apr 24 16:06:16 +0200 2025
...
echo "xvhdl --incr --relax -prj tb_UD_counter_vhdl.prj"
call xvhdl  --incr --relax -prj tb_UD_counter_vhdl.prj -log xvhdl.log
